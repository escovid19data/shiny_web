        ...
        column(12,
               column(3,
                      selectInput(ns("select1"), "Variable",
                                  choices = c("Hospitalizados", "Hospitalizados acumulados",
                                              "UCI",
                                              "UCI Acumulados", "Hospitalizados media móvil semanal",
                                              "UCI media móvil semanal"))
               ),
               column(3,
